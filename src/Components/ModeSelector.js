...
import { Collapse, Col, CustomInput } from "reactstrap";
...
const options = [
  {
    key: "g1",
    value: "g1",
    text: getDate(0) + " - SMT Away Team @ SMT Home Team"
  },
  {
    key: "g2",
    value: "g2",
    text: getDate(1) + " - SMT Away Team @ SMT Home Team"
  },
  {
    key: "g3",
    value: "g3",
    text: getDate(2) + " - SMT Away Team @ SMT Home Team"
  },
  {
    key: "g4",
    value: "g4",
    text: getDate(3) + " - SMT Away Team @ SMT Home Team"
  },
  {
    key: "g5",
    value: "g5",
    text: getDate(4) + " - SMT Away Team @ SMT Home Team"
  },
  {
    key: "g6",
    value: "g6",
    text: getDate(5) + " - SMT Away Team @ SMT Home Team"
  },
  {
    key: "g7",
    value: "g7",
    text: getDate(6) + " - SMT Away Team @ SMT Home Team"
  },
  {
    key: "g8",
    value: "g8",
    text: getDate(7) + " - SMT Away Team @ SMT Home Team"
  },
  {
    key: "g9",
    value: "g9",
    text: getDate(8) + " - SMT Away Team @ SMT Home Team"
  },
  {
    key: "g10",
    value: "g10",
    text: getDate(9) + " - SMT Away Team @ SMT Home Team"
  }
];
const PlayerOpts = [
          ...
          <Col
            style={
              this.state.collapsed === true
                ? { borderTop: "4px solid #62AA58", paddingBottom: "5px" }
                : {
                    borderTop: "4px solid #62AA58",
                    borderBottom: "4px solid #62AA58",
                    paddingBottom: "5px"
                  }
            }
          >
