          ...
          <Header as="h2" style={{ color: "white" }}>
            ...
            <Header.Content>
              ...
              <Header.Subheader style={{ color: "white" }}>
                Data metrics for selected game.
              </Header.Subheader>
            </Header.Content>
          </Header>
          <Tab
                      ...
                      <Card.Content>
                        ...
                        <Card.Meta style={{ textAlign: "center" }}>
                          <List size="large" divided horizontal selection>
                            <List.Item onClick={this.inningChange}>1</List.Item>
                            <List.Item onClick={this.inningChange}>2</List.Item>
                            <List.Item onClick={this.inningChange}>3</List.Item>
                            <List.Item onClick={this.inningChange}>4</List.Item>
                            <List.Item onClick={this.inningChange}>5</List.Item>
                            <List.Item onClick={this.inningChange}>6</List.Item>
                            <List.Item onClick={this.inningChange}>7</List.Item>
                            <List.Item onClick={this.inningChange}>8</List.Item>
                            <List.Item onClick={this.inningChange}>9</List.Item>
                          </List>
                        </Card.Meta>
                      </Card.Content>
                    </Card>
        ...
        <div>
          <Header as="h2" style={{ color: "white" }}>
            ...
            <Header.Content>
              Pitch Data
              <Header.Subheader style={{ color: "white" }}>
                Data metrics for selected pitch.
              </Header.Subheader>
            </Header.Content>
          </Header>
          <Tab
        ...
        <div>
          <Header as="h2" style={{ color: "white" }}>
            ...
            <Header.Content>
              Camera Selection
              <Header.Subheader style={{ color: "white" }}>
                Camera feeds for selected pitch.
              </Header.Subheader>
            </Header.Content>
          </Header>
