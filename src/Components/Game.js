								...
								render: () => (
									<Tab.Pane>
										<Card centered color="blue">
											<Card.Content>
												<Card.Header style={{ textAlign: "center" }}>Inning Selection</Card.Header>
										...
										<Header style={{ textAlign: "center", verticalAlign: "bottom" }}>
											<Button compact color="blue" floated="left" onClick={this.halfChange}>
												Top
											</Button>
											{this.state.halfInning} {this.state.selectedInning}
											<Button compact color="blue" floated="right" onClick={this.halfChange}>
												Bottom
											</Button>
										</Header>
										<Accordion
														...
														content: (
															<div>
																...
																<List divided selection relaxed>
																	<List.Item>
																		<List.Icon name="baseball ball" color="red" size="large" verticalAlign="middle" />
																	...
																	<List.Item>
																		<List.Icon name="baseball ball" color="green" size="large" verticalAlign="middle" />
																	...
																	<List.Item>
																		<List.Icon name="baseball ball" color="blue" size="large" verticalAlign="middle" />
